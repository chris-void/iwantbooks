...
当前用户：<s:property value="#session.user_name"/>
  ...
  <div class="login" class="animate form">
    ...
    <p>旧密码： </p><input type="password" id="password" name="oldpass" required="required" placeholder="password" />
	<p>新密码： </p><input type="password" id="password" name="newpass1" required="required" placeholder="password" />
	<p>确认新密码：</p><input type="password" id="password" name="newpass2" required="required" placeholder="password" />
	
	<s:submit value="提交啦" theme="simple"/><s:reset  theme="simple" value="清空"/></div>
 <span>
  <s:if test="tip!=null">
<div class="error">
